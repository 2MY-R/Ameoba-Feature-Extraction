...
## Introduction
&nbsp; The aim of this project is to expand upon and streamline the first stage in a broader mission to predict the behaviour of cells; such research could be game-changing within bio-medical fields of study. To achieve our larger aim, a system of amoeba and yeast has been chosen to be studied, which can be easily observed, and large amounts of footage can be captured for analysis. The project uses several programs written to take the raw footage of amoeba and yeast taken in phase-contrast and export datasets of their morphological, temporal and spatial features. My contribution to projects is streamlining and expanding this process and cleaning the output data for future projects. As we advance, the outcome of this project is vital for providing future machine learning models with quality datasets required to begin cell behavioural prediction. 
